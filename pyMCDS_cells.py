...
class pyMCDS_cells:
    """
    This class contains a dictionary of dictionaries that contains all of the cells'
    output (not substrates) from a single time step of a PhysiCell Model. This class assumes that
