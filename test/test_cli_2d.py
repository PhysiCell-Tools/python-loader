...
class TestPyCliAnndata(object):
    ...
    def test_pcdl_get_anndata_timeseries(self):
        ...
        #print(f'\ns_result.stdout: {s_result.stdout}\n')
        #print(f'\ns_result.stderr: {s_result.stderr}\n')
        s_opathfile = s_result.stderr.decode('UTF8').replace('\r','').replace('\n','').replace('<sys>','sys').replace('sys:1: DeprecationWarning: Call to deprecated function (or staticmethod) _destroy.','')  # bue 20250307: >= python3.11
    ...
    def test_pcdl_get_anndata_timeseries_collapsed(self):
        ...
        #print(f'\ns_result.stdout: {s_result.stdout}\n')
        #print(f'\ns_result.stderr: {s_result.stderr}\n')
        ls_opathfile = s_result.stderr.decode('UTF8').replace('\r','').replace('<sys>','sys').replace('sys:1: DeprecationWarning: Call to deprecated function (or staticmethod) _destroy.\n','').replace("['","").replace("']\n","").split("', '")  # bue 20250307: >= python3.11
        assert len(ls_opathfile) == 25 and \
